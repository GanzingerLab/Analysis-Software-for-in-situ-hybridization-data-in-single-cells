function [r,b,r_dye,b_dye, r_start, r_end, c_start, c_end, start_point_cell,offset] = select_region_auto_shiftcorr(i_red,i_blue,image_red_dye,image_blue_dye,nImage)
...
if abs(offset(1)) < 10 && abs(offset(2)) <10 && offset(1) ~= 0
