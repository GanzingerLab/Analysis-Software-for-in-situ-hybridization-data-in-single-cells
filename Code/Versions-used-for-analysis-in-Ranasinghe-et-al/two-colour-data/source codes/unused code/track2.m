...
function tracks = track2(Results_final,max_step,param)
xyzs=Results_final;
maxdisp=max_step;
% modified by Kristina in l. 1063 to be able to use it with 'goodenough'
% set to 0
%
...
if nargin==2
    ...
    goodenough = 1;  % if goodenough is not wanted set to zero
    dim = dd - 1;
    quiet=0;
else
    memory_b    =   param.mem;
