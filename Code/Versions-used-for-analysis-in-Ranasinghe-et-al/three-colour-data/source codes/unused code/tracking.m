function [length_tracks,result_tracks_SNR,Results_final] = tracking(Results,xyaSNRma,save_name,param)
global n n3
        ...
        if size(Results_final,1)>1
            ...
            if ~isempty(result_tracks)
                ...
                for i=1:i_result_tracks
                    ...
                    ll=find(tt==a(1));
                    temp=tt(ll,:);
                    result_tracks_SNR_temp=[a,temp(3:6)];
                ...
                for nt=1:result_tracks((size(result_tracks,1)-1),4)
                    ...
                    if length(a) > param.good
                        ...
                        temp(:,2:7)=result_tracks_SNR(a,[1,2,5,6,7,8]);
